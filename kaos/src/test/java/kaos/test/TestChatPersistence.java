...
////////////////// Tests for Private and Team Messages ///////////////////
    ...
    public void testPMCreate() throws Exception{
        ...
        PrivateMessage pm = new PrivateMessage("hej hopp", chat.getUserList().getByLogin("uhrj"), chat.getUserList().getByLogin("fodavid"));
    ...
    public void testPMFindRange() throws Exception{
        ...
        chat.getUserList().create(s);
        chat.getUserList().create(r);
        PrivateMessage pm1 = new PrivateMessage("meddelande 1", chat.getUserList().getByLogin("uhrj"), chat.getUserList().getByLogin("fodavid"));
        PrivateMessage pm2 = new PrivateMessage("meddelande 2", chat.getUserList().getByLogin("uhrj"), chat.getUserList().getByLogin("fodavid"));
        PrivateMessage pm3 = new PrivateMessage("meddelande 3", chat.getUserList().getByLogin("uhrj"), chat.getUserList().getByLogin("fodavid"));
    ...
    public void testPMgetBySender() throws Exception{
        ...
        PrivateMessage pm2 = new PrivateMessage("meddelande 2", chat.getUserList().getByLogin("uhrj"), chat.getUserList().getByLogin("fodavid"));
        PrivateMessage pm3 = new PrivateMessage("meddelande 3", chat.getUserList().getByLogin("uhrj"), chat.getUserList().getByLogin("fodavid"));
        PrivateMessage pm4 = new PrivateMessage("meddelande 4", chat.getUserList().getByLogin("fodavid"), chat.getUserList().getByLogin("uhrj"));
        PrivateMessage pm5 = new PrivateMessage("meddelande 5", chat.getUserList().getByLogin("uhrj"), chat.getUserList().getByLogin("fodavid"));
        PrivateMessage pm6 = new PrivateMessage("meddelande 6", chat.getUserList().getByLogin("fodavid"), chat.getUserList().getByLogin("uhrj"));
        PrivateMessage pm7 = new PrivateMessage("meddelande 7", chat.getUserList().getByLogin("uhrj"), chat.getUserList().getByLogin("fodavid"));
        PrivateMessage pm8 = new PrivateMessage("meddelande 8", chat.getUserList().getByLogin("fodavid"), chat.getUserList().getByLogin("uhrj"));
        PrivateMessage pm9 = new PrivateMessage("meddelande 9", chat.getUserList().getByLogin("uhrj"), chat.getUserList().getByLogin("fodavid"));
        chat.getPrivateMessageList().create(pm1);
        chat.getPrivateMessageList().create(pm2);
        chat.getPrivateMessageList().create(pm3);
    ...
    public void testTMCreate() throws Exception{
        ...
        TeamMessage tm = new TeamMessage("hej hopp", chat.getUserList().getByLogin("uhrj"), chat.getTeamList().getByTeamName("test_team"));
    ...
    public void testTMFindRange() throws Exception{
        ...
        chat.getUserList().create(s);
        chat.getTeamList().create(t);
        TeamMessage tm1 = new TeamMessage("meddelande 1", chat.getUserList().getByLogin("uhrj"), chat.getTeamList().getByTeamName("test_team"));
        TeamMessage tm2 = new TeamMessage("meddelande 2", chat.getUserList().getByLogin("uhrj"), chat.getTeamList().getByTeamName("test_team"));
        TeamMessage tm3 = new TeamMessage("meddelande 3", chat.getUserList().getByLogin("uhrj"), chat.getTeamList().getByTeamName("test_team"));
    ...
    public void testTMgetBySender() throws Exception{
        ...
        TeamMessage tm1 = new TeamMessage("meddelande 1", chat.getUserList().getByLogin("uhrj"), chat.getTeamList().getByTeamName("test_team1"));
        TeamMessage tm2 = new TeamMessage("meddelande 2", chat.getUserList().getByLogin("uhrj"), chat.getTeamList().getByTeamName("test_team1"));
        TeamMessage tm3 = new TeamMessage("meddelande 3", chat.getUserList().getByLogin("uhrj"), chat.getTeamList().getByTeamName("test_team2"));
        TeamMessage tm4 = new TeamMessage("meddelande 4", chat.getUserList().getByLogin("fodavid"), chat.getTeamList().getByTeamName("test_team1"));
        TeamMessage tm5 = new TeamMessage("meddelande 5", chat.getUserList().getByLogin("fodavid"), chat.getTeamList().getByTeamName("test_team1"));
        TeamMessage tm6 = new TeamMessage("meddelande 6", chat.getUserList().getByLogin("fodavid"), chat.getTeamList().getByTeamName("test_team2"));
        TeamMessage tm7 = new TeamMessage("meddelande 7", chat.getUserList().getByLogin("fodavid"), chat.getTeamList().getByTeamName("test_team2"));
        TeamMessage tm8 = new TeamMessage("meddelande 8", chat.getUserList().getByLogin("fodavid"), chat.getTeamList().getByTeamName("test_team2"));
        TeamMessage tm9 = new TeamMessage("meddelande 9", chat.getUserList().getByLogin("fodavid"), chat.getTeamList().getByTeamName("test_team2"));
        chat.getTeamMessageList().create(tm1);
        chat.getTeamMessageList().create(tm2);
        chat.getTeamMessageList().create(tm3);
